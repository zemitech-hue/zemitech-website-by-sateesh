...
const constructionServices: ServiceItem[] = [
  ...
  },
  {
    ...
    category: "construction",
    tag: "Commercial",
    description: "Shell-and-core to move-in office fit-outs completed on compressed schedules with HVAC & fire compliance.",
    href: "/construction/commercial",
    image: "/images/services/service-commercial.jpg",
    highlights: ["45-Day Compressed Execution", "HVAC & Fire Compliance", "Acoustic Glass Partitions"],
  },
  {
    title: "Township Infrastructure & Roads",
    category: "construction",
    tag: "Infrastructure",
    description: "Arterial asphalt road networks, stormwater drainage, compound walls, and amenity blocks.",
    href: "/construction/infrastructure",
    image: "/images/services/service-infrastructure.jpg",
    highlights: ["Asphalt & Concrete Paving", "Stormwater Drainage", "Amenity & Security Blocks"],
  },
  {
