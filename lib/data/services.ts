...
export const subServices: Record<string, SubService> = {
  "construction-residential": {
    ...
    metaTitle: "Residential Construction Company in Pune | Zemara Spaces",
    metaDescription:
      "Custom villas & independent homes built in Pune by Zemara Spaces — fixed BOQ, stage-wise billing, 8-11 month timelines.",
    ...
    cards: {
      ...
      sub: "Types of residential projects Zemara Spaces designs and constructs.",
      items: [
        {
  ...
  "construction-industrial": {
    ...
    metaTitle: "Industrial Warehouse Construction Pune | Zemara Spaces",
    ...
    faqs: [
      ...
      { question: "Do you build industrial sheds outside Pune city limits?", answer: "Yes — our industrial and PEB shed projects extend across the wider Pune region and our other operational cities (Mumbai, Nagpur, Indore and more), not just within city limits." },
    ],
  ...
  "construction-renovation": {
    ...
    metaTitle: "Home Renovation Contractor in Pune | Zemara Spaces",
    ...
    faqs: [
      ...
      { question: "Do you take up home renovation projects across Baner, Kothrud, Wakad and Hinjewadi?", answer: "Yes — our renovation team covers these and other Pune localities including Viman Nagar, Kondhwa and Hadapsar, alongside our other operational cities." },
    ],
  ...
  "construction-structural-civil-engineering": {
    ...
    metaTitle: "Structural & Civil Engineering Pune | Zemara Spaces",
    ...
    faqs: [
      ...
      { question: "Do you provide structural and civil engineering services across Pune and PCMC, or only within city limits?", answer: "We cover greater Pune and PCMC, including Baner, Wakad, Hinjewadi, Kothrud and Bavdhan, along with our other operational cities." },
    ],
  ...
  "interior-kitchen": {
    ...
    metaTitle: "Modular Kitchen Interior Design in Pune | Zemara Spaces",
    ...
    faqs: [
      ...
      { question: "Do you install modular kitchens in Baner, Wakad, Hinjewadi and Kothrud?", answer: "Yes — our modular kitchen team delivers across these and other Pune localities including Viman Nagar, Bavdhan and Pimple Saudagar, plus our other operational cities." },
    ],
  ...
  "interior-living-room": {
    ...
    metaTitle: "Living Room Interior Design in Pune | Zemara Spaces",
    ...
    faqs: [
      ...
      { question: "Which Pune localities do you cover for living room interior projects?", answer: "We deliver living room interiors across Baner, Kothrud, Hinjewadi, Viman Nagar, Wakad and Hadapsar, along with our other operational cities." },
    ],
  ...
  "interior-bedroom": {
    ...
    metaTitle: "Bedroom Interior Design in Pune | Zemara Spaces",
    ...
    faqs: [
      ...
      { question: "Do you design bedroom interiors for homes in Viman Nagar, Kondhwa or Wagholi?", answer: "Yes — our bedroom interior team covers these and other Pune localities including Baner, Hinjewadi and Kothrud, plus our other operational cities." },
    ],
  ...
  "interior-office": {
    ...
    metaTitle: "Office Interior Design Pune | Zemara Spaces",
    ...
    faqs: [
      ...
      { question: "Do you handle office interior fit-outs in the Hinjewadi and Baner IT corridor?", answer: "Yes — office fit-outs in Hinjewadi, Baner, Wakad and Kothrud are a regular part of our commercial scope, alongside our other operational cities." },
    ],
...
export const turnkeyHomeInteriors: SubService = {
  ...
  metaTitle: "Turnkey 2BHK & 3BHK Home Interiors | Zemara Spaces",
  ...
  faqs: [
    ...
    { question: "Do you execute turnkey 2BHK/3BHK interiors across Pune's major residential hubs like Baner, Wakad, Kothrud and Hadapsar?", answer: "Yes — our turnkey team delivers across these and other Pune localities including Hinjewadi, Viman Nagar and Kondhwa, plus our other operational cities." },
  ],
