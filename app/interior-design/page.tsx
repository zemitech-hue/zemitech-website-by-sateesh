    ...
    <>
      ...
      <section className="py-20 bg-white">
        <Container>
          ...
          <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-8 [&>*:last-child:nth-child(odd)]:sm:col-span-2 [&>*:last-child:nth-child(odd)]:sm:max-w-[calc(50%-1rem)] [&>*:last-child:nth-child(odd)]:sm:mx-auto">
