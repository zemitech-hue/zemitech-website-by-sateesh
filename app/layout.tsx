...
export const metadata: Metadata = {
  ...
  description:
    "Zemitech Urban is a turnkey construction and interior design company delivering residential, commercial, and infrastructure projects, and full-home interiors, under one accountable team.",
  keywords: [
